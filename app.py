...
# -------------------------------
cursor.execute("SELECT * FROM users WHERE username=%s", ("reception",))
if cursor.fetchone() is None:
    cursor.execute("INSERT INTO users (username, password) VALUES (%s, %s)", ("reception", "1234"))

cursor.execute("SELECT * FROM users WHERE username=%s", ("manager",))
if cursor.fetchone() is None:
    cursor.execute("INSERT INTO users (username, password) VALUES (%s, %s)", ("manager", "1234"))
